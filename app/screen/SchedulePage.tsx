                        ...
                        <ScrollView>
                            {
                                schedule.map((item, index) => (
                                    <>
                                        <StyledView key={`${item.id}-${index}-${userData.id}`} className="bg-white rounded-b-2xl rounded-tr-2xl w-full h-auto p-3">
                                            ...
                                            <StyledView className="flex-row gap-2 py-2">
                                                {
                                                    item.jobs.map((job, index) => {
                                                        return (
                                                            <StyledView key={`${job}-${index}`} className="bg-[#EB3834] rounded-full">
                                                                <StyledText className="font-custom text-white px-3 py-1">{job}</StyledText>
                                                            </StyledView>
                                                        )
                                                    })
                                                }
